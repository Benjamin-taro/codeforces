...
bool is_corner(int64_t x, int64_t y, int64_t h, int64_t w) {
    if((x==1 && y==1) || (x==1 && y==w) || (x==h && y==1) || (x==h && y==w)) return true;
    return false;
}

bool is_edge(int64_t x, int64_t y, int64_t h, int64_t w) {
...
int main() {
    ...
    while(t--){
        ...
        cin >> x1 >> y1 >> x2 >>
         y2;
        if(is_corner(x1, y1, n, m) || is_corner(x2, y2, n, m)){
            cout << 2 << endl;
        }
        else if(is_edge(x1, y1, n, m) || is_edge(x2, y2, n, m)){
            cout << 3 << endl;
        }
        else{
            cout << 4 << endl;
