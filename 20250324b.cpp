...
bool exception2(string s){
    if(s[0] == s[1]) return true;
    return false;
}
bool exception3(string s){
    if (s[0] != s[1] && s[1] != s[2] && s[2] != s[0]) return true;
    return false;
}
...
int main() {
    ...
    while(t--){
        ...
        if (n == 1) {
            ...
            for (int i = 0; i < n; i++) {
                if (i + 1 < n && exception2(s.substr(i, 2))) {
                    cout << s[i] << s[i + 1] << endl;
                    flag = true;
                    break;
                }
                else if (i + 2 < n && exception3(s.substr(i, 3))) {
